...
public class KfadJukeboxManager {
    public static final int TICKS_PER_SECOND = 20;
    private long ticksSinceSongStarted;
    @Nullable
    private RegistryEntry<JukeboxSong> song;
    private final BlockPos pos;
    private final KfadJukeboxManager.ChangeNotifier changeNotifier;

    public KfadJukeboxManager(KfadJukeboxManager.ChangeNotifier changeNotifier, BlockPos pos) {
