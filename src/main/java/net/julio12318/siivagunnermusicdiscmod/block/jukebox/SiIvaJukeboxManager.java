...
public class SiIvaJukeboxManager {
    public static final int TICKS_PER_SECOND = 20;
    private long ticksSinceSongStarted;
    @Nullable
    private RegistryEntry<JukeboxSong> song;
    private final BlockPos pos;
    private final SiIvaJukeboxManager.ChangeNotifier changeNotifier;

    public SiIvaJukeboxManager(SiIvaJukeboxManager.ChangeNotifier changeNotifier, BlockPos pos) {
