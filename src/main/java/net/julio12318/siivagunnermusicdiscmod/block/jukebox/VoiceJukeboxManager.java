...
public class VoiceJukeboxManager {
    public static final int TICKS_PER_SECOND = 20;
    private long ticksSinceSongStarted;
    @Nullable
    private RegistryEntry<JukeboxSong> song;
    private final BlockPos pos;
    private final VoiceJukeboxManager.ChangeNotifier changeNotifier;

    public VoiceJukeboxManager(VoiceJukeboxManager.ChangeNotifier changeNotifier, BlockPos pos) {
